...
<body>
    <h1>Editar Vehículo #{{ $vehiculo->id }}</h1>
    ...
    <div class="card">
        <form action="{{ route('vehiculos.update', $vehiculo->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="anio" name="anio" value="{{ old('anio', $vehiculo->anio) }}" min="1900" max="2100">
            ...
            <div class="form-group">
                ...
                <input type="text" id="propietario" name="propietario" value="{{ old('propietario', $vehiculo->propietario) }}">
